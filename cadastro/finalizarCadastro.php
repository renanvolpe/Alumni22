					...
					<div class="card-body">
						<form class="mt-3">
							...
							<div class="mt-2 custom-file">
  								 <input type="file" name="arquivos" id="customFile" class="btn rounded-pill" multiple/>
  								<!--<input lang="pt" type="file" class="custom-file-input" id="customFile">
            ...
            limpa_formulário_cep();
							...
							<div class="form-row">
								<div class="col-12 my-1 mt-4">
							      	<div class="input-group rounded-pill border">
							        	<div class="input-group-prepend">
							          		<div class="input-group-text border-0 bg-transparent"><i class="fas fa-phone"></i></div>
							        	</div>
							        	<input type="text" class="form-control border-0 rounded-pill" id="telefone" name="telefone" maxlength="12" placeholder="Digite seu telefone" required="">
							      	</div>
							    </div>
							</div>
							...
							<div class="form-row">
								<div class="col-6 my-1 mt-4">
							      	<div class="input-group rounded-pill border">
							        	<div class="input-group-prepend">
							          		<div class="input-group-text border-0 bg-transparent"><i class="fas fa-calendar"></i></div>
							        	</div>
							        	<input type="text" class="form-control border-0 rounded-pill" id="ingresso" name="dataIngresso" placeholder="Ano de Ingresso no Curso" required="">
							      	</div>
							    </div>
							    ...
							    <div class="col-6 my-1 mt-4">
							      	<div class="input-group rounded-pill border">
							        	...
							        	<input type="text" class="form-control border-0 rounded-pill" id="termino" name="dataTermino" placeholder="Ano de Termino do Curso" required="">
							      	</div>
							    </div>
							</div>
